/* ===================================================================
   ...
   WHAT IT PRODUCES, in the scratch directory named on the command line:
     ...
     trip-q050.png / trip-q100.png / trip-q200.png
                                             THE TRIPTYCH at a count the floor
                                   permits, on the shipping tree (item 4)
     floor-11-q050--control.png              the same-tree control: the
                                             first cell shot twice
     trip-q050--control.png                  the triptych's own same-tree
...
async function cell({ id, q, samples, frame, count = 2 }) {
  const sets = { lobeDepth: 0.3, lobeCount: count, lobeTipShape: q };
...
const cells = [
  ...
  { id: 'floor-11-q050', q: 0.5, samples: 11 }, { id: 'floor-11-q100', q: 1, samples: 11 }, { id: 'floor-11-q200', q: 2, samples: 11 },
  /* one step below */
  { id: 'floor-10-q050', q: 0.5, samples: 10 }, { id: 'floor-10-q100', q: 1, samples: 10 }, { id: 'floor-10-q200', q: 2, samples: 10 },
  ...
  { id: 'floor-08-q050', q: 0.5, samples: 8 }, { id: 'floor-08-q100', q: 1, samples: 8 }, { id: 'floor-08-q200', q: 2, samples: 8 },
  { id: 'floor-06-q050', q: 0.5, samples: 6 }, { id: 'floor-06-q100', q: 1, samples: 6 }, { id: 'floor-06-q200', q: 2, samples: 6 },
  /* the first sheet's condition — four stations a lobe — at two lobes (the same pitch as above) */
  { id: 'floor-04-q050', q: 0.5, samples: 4 }, { id: 'floor-04-q100', q: 1, samples: 4 }, { id: 'floor-04-q200', q: 2, samples: 4 },
  /* and at SIX lobes, the triptych Eva ruled on, reproduced: 4 stations a lobe on a 2.38 mm pitch */
  { id: 'six-04-q050', q: 0.5, samples: 4, count: 6 }, { id: 'six-04-q100', q: 1, samples: 4, count: 6 }, { id: 'six-04-q200', q: 2, samples: 4, count: 6 },
  /* THE TRIPTYCH on the shipping tree, at the count the floor permits */
  { id: 'trip-q050', q: 0.5, samples: null }, { id: 'trip-q100', q: 1, samples: null }, { id: 'trip-q200', q: 2, samples: null },
];
...
const CONTROLLED = new Set([cells[0].id, 'trip-q050']);
