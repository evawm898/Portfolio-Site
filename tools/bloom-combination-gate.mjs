...
export const COMBINATION_XFAIL = Object.freeze({
  ...
  'cup-x-tipshape @ petalCup=0.6 x petalTipShape=2.5': { mm: 0.97, note: 'NEW WITH THE APEX NIB, and it is the §18a family reaching ONE STEP FURTHER DOWN the cup column: 1.026 mm on a worktree of 2464d50, 0.970 here. The nib truncates the law at the print floor and closes it on a flank and an arc, so the last stretch of blade stops being a parallel strip and the two margins converge — the wall instrument excludes the nib itself and this is the geometry just below it. Measured on the apex-nib tree, Node 22.' },
  'gradient-x-tipshape @ petalCupGradient=0.6 x petalTipShape=2.5': { mm: 0.971, note: 'NEW WITH THE APEX NIB — the cup gradient\'s mirror of the cell above, as this pair has been throughout (#265 measured it within 0.004 mm of the plain cup\'s at the same numbers). 1.024 mm on a worktree of 2464d50, 0.971 here.' },
  'cup-x-thinning @ petalCup=0.6 x tipThinning=0.4': { mm: 0.96, note: 'NEW WITH THE APEX NIB: 1.023 mm on a worktree of 2464d50, 0.960 here. The same cup column one step down, on the thinned tip rather than the tip shape.' },
  'cup-x-thinning @ petalCup=0.6 x tipThinning=0.8': { mm: 0.96, note: 'NEW WITH THE APEX NIB: 1.023 mm on a worktree of 2464d50, 0.960 here. Identical to the 0.4 cell because tipThinning SATURATES against the export print floor above 0.4 — #265\'s own note, unchanged by the nib.' },
  'cup-x-length @ petalCup=1.2 x petalLength=20': { mm: 0.994, note: 'NEW WITH THE APEX NIB, AND #263 SAID SO IN ADVANCE: its own citation for this pair reads ‘measured CLEAR and close: 1.012 mm at cup 1.2 x a 20 mm blade, twelve microns of headroom’. The twelve microns are spent — 1.012 mm on a worktree of 2464d50, 0.994 here. A shorter blade meets the print floor at a LOWER station, so the nib\'s cap is a larger fraction of it.' },
  ...
  /* THE CUP UNDER THE SWEEP — `kS` multiplying `cupLift` in `sectAt`,
     ...
     cup 0). */
  'cup-x-apexsweep @ petalCup=0.9 x petalApexSweep=1': { mm: 0.998, note: 'measured 2026-09-19 on c29a8b5. — RE-RECORDED BY THE APEX NIB: was 0.936 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  ...
  'cup-x-apexsweep @ petalCup=1.2 x petalApexSweep=1': { mm: 0.967, note: 'measured 2026-09-19 on c29a8b5 — the worst cell of this pair, 0.213 mm beyond what the cup reaches alone. — RE-RECORDED BY THE APEX NIB: was 0.818 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  ...
  'gradient-x-tipshape @ petalCupGradient=0.6 x petalTipShape=3': { mm: 0.892, note: "measured 2026-09-19 on c29a8b5; `cup-x-tipshape`'s own cell at the same numbers reads 0.929. — RE-RECORDED BY THE APEX NIB: was 0.928 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument's own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22." },
  'gradient-x-tipshape @ petalCupGradient=0.9 x petalTipShape=2.5': { mm: 0.901, note: 'measured 2026-09-19 on c29a8b5; the cup reads 0.988 at the same numbers. — RE-RECORDED BY THE APEX NIB: was 0.985 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'gradient-x-tipshape @ petalCupGradient=0.9 x petalTipShape=3': { mm: 0.802, note: 'measured 2026-09-19 on c29a8b5; the cup reads 0.854. — RE-RECORDED BY THE APEX NIB: was 0.850 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'gradient-x-tipshape @ petalCupGradient=1.2 x petalTipShape=2.5': { mm: 0.864, note: 'measured 2026-09-19 on c29a8b5; the cup reads 0.977. — RE-RECORDED BY THE APEX NIB: was 0.974 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'gradient-x-tipshape @ petalCupGradient=1.2 x petalTipShape=3': { mm: 0.754, note: 'measured 2026-09-19 on c29a8b5 — the worst cell of this pair; the cup reads 0.832 at the same numbers. — RE-RECORDED BY THE APEX NIB: was 0.828 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  ...
  'gradient-x-curl @ petalCupGradient=0.9 x petalSpineCurl=360': { mm: 0.899, note: 'measured 2026-09-19 on c29a8b5; the plain cup reads 0.118 — this one the gradient is KINDER to. — RE-RECORDED BY THE APEX NIB: was 0.678 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  ...
  /* ONE LIFT, TWO CONTROLS — AND THE MEASURE DEPENDS ON THEIR SUM. Read
     ...
     source. */
  'cup-x-gradient @ petalCup=0.6 x petalCupGradient=0.9': { mm: 1.000, note: 'measured 2026-09-19 on c29a8b5; the cup+gradient sum is 1.5, and the other 1.5 cell reads 0.938 too. — RE-RECORDED BY THE APEX NIB: was 0.938 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-gradient @ petalCup=0.6 x petalCupGradient=1.2': { mm: 0.944, note: 'measured 2026-09-19 on c29a8b5; sum 1.8. — RE-RECORDED BY THE APEX NIB: was 0.862 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-gradient @ petalCup=0.9 x petalCupGradient=0.6': { mm: 0.999, note: 'measured 2026-09-19 on c29a8b5; sum 1.5. — RE-RECORDED BY THE APEX NIB: was 0.938 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-gradient @ petalCup=0.9 x petalCupGradient=0.9': { mm: 0.943, note: 'measured 2026-09-19 on c29a8b5; sum 1.8. — RE-RECORDED BY THE APEX NIB: was 0.862 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-gradient @ petalCup=0.9 x petalCupGradient=1.2': { mm: 0.897, note: 'measured 2026-09-19 on c29a8b5; sum 2.1. — RE-RECORDED BY THE APEX NIB: was 0.801 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-gradient @ petalCup=1.2 x petalCupGradient=0.6': { mm: 0.943, note: 'measured 2026-09-19 on c29a8b5; sum 1.8. — RE-RECORDED BY THE APEX NIB: was 0.862 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-gradient @ petalCup=1.2 x petalCupGradient=0.9': { mm: 0.897, note: 'measured 2026-09-19 on c29a8b5; sum 2.1. — RE-RECORDED BY THE APEX NIB: was 0.801 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-gradient @ petalCup=1.2 x petalCupGradient=1.2': { mm: 0.858, note: 'measured 2026-09-19 on c29a8b5 — the worst cell of this pair; sum 2.4, the only cell at it. — RE-RECORDED BY THE APEX NIB: was 0.754 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  ...
  'cup-x-width @ petalCup=0.9 x petalWidth=30': { mm: 0.947, note: 'measured 2026-09-19 on c29a8b5; petalWidth 30 alone reads 1.219 and cup 0.9 alone 1.138, both clear. — RE-RECORDED BY THE APEX NIB: was 0.954 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-width @ petalCup=1.2 x petalWidth=30': { mm: 0.916, note: 'measured 2026-09-19 on c29a8b5 — the worst cell of this pair. — RE-RECORDED BY THE APEX NIB: was 0.932 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  ...
  'cup-x-thinning @ petalCup=0.9 x tipThinning=0.4': { mm: 0.938, note: 'measured 2026-09-19 on c29a8b5. — RE-RECORDED BY THE APEX NIB: was 0.984 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-thinning @ petalCup=0.9 x tipThinning=0.8': { mm: 0.938, note: 'measured 2026-09-19 on c29a8b5 — identical to 0.4: the export floor has already bound. — RE-RECORDED BY THE APEX NIB: was 0.984 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-thinning @ petalCup=1.2 x tipThinning=0.4': { mm: 0.931, note: 'measured 2026-09-19 on c29a8b5 — the worst cell of this pair. — RE-RECORDED BY THE APEX NIB: was 0.924 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
  'cup-x-thinning @ petalCup=1.2 x tipThinning=0.8': { mm: 0.931, note: 'measured 2026-09-19 on c29a8b5 — identical to 0.4: the export floor has already bound. — RE-RECORDED BY THE APEX NIB: was 0.924 mm. The nib truncates the law at the print floor and closes it on a flank and an arc, so every station near the tip sits at a different physical place and the drawn blade is up to +0.124 mm longer; the wall instrument\'s own exclusion is the NIB and exactly the nib (see `nibFromU`), so this is the geometry outside it. Measured on the apex-nib tree, Node 22.' },
});
