...
/* THE BEFORE SET CARRIES `labellumTipEnd` AND THE PER-PETAL SET CANNOT,
...
const LAB = { labellumSize: 1.6, labellumTilt: -25, labellumCup: 0.5, labellumCurl: -60, labellumTipEnd: 0.5 };
