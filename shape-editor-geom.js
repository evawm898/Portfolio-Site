...
//
// necklineHeightFn is a faithful port of neckline.py's NecklineV3.height,
// validated against it directly (22 thetas across every segment/knot
// region plus mirrored and >180deg raw values — max abs error ~1e-11mm).
// buildMeshes uses it to trim the top of the live 3D mesh to the real
// neckline curve — a per-column z-range clip, not a re-solve.
//
